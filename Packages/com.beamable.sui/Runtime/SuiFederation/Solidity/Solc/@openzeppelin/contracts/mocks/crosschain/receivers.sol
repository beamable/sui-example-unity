...
import "../../crosschain/sui/CrossChainEnabledSuiChild.sol";
 ...
 * Sui
 */
contract CrossChainEnabledSuiChildMock is Receiver, CrossChainEnabledSuiChild {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor(address bridge) CrossChainEnabledSuiChild(bridge) {}
}
