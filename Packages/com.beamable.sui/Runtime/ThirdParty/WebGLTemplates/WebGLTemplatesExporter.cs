...
public class WebGLTemplatesExporter
{
    ...
    private static void OnScriptsReloaded()
    {
        ...
        var sourceRootFolder =
            Path.GetFullPath(
                "Packages/com.beamable.sui/Runtime/ThirdParty/WebGLTemplates/");
        ...
        // Iterate trough all the template folders in Packages/com.beamable.sui/Runtime/ThirdParty/WebGLTemplates/ and copy them over to Assets/WebGLTemplates
