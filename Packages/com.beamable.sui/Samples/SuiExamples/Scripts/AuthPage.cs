...
namespace SuiExamples.Scripts
{
    ...
    public class AuthPage : TabPage
    {
        ...
        {
            var address = $"https://mumbai.suiscan.com/address/{Data.WalletId}";
            ...
            async Promise SendAttachRequest(ChallengeSolution challengeSolution = null)
            {
                ...
                if (Data.WalletConnected)
                {
                    RegistrationResult result =
                        await Ctx.Accounts.AddExternalIdentity<SuiCloudIdentity, SuiFederationClient>(
                            Data.WalletId,
                            SolveChallenge);
        ...
        private async void OnDetachClicked()
        {
            ...
            await Ctx.Accounts.RemoveExternalIdentity<SuiCloudIdentity, SuiFederationClient>();
